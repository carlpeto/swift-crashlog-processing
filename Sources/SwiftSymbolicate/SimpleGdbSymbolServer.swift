...
public class SimpleGdbSymbolServer: SymbolServer {
    ...
    public func fetch(
        ...
        if debug {
            print("SimpleGdbSymbolServer: fetching image: \(uuid), " +
        ...
        if let cachedFileLastModifiedDate {
            ...
            if debug {
                print("SimpleGdbSymbolServer sending previous cached file last mod date: \(lastModifiedDateFormatted)")
            }
        }
        ...
        do {
            ...
            if debug {
                print("SimpleGdbSymbolServer: error: \(error.localizedDescription), \((error as? NSError)) : \((error as? NSError)?.userInfo)")
            }
